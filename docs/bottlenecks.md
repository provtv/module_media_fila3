...
command=php /var/www/html/base_saluteora/laravel/artisan queue:work database --queue=media --sleep=3 --tries=3 --max-time=3600
autostart=true
autorestart=true
user=www-data
numprocs=2
redirect_stderr=true
stdout_logfile=/var/www/html/base_saluteora/laravel/storage/logs/media-worker.log
```
