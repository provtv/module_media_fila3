...
<head>
    ...
    <style type="text/css">
        <?php echo e(cssInLine('notify::css/ark.css')); ?>
                                ...
                                <td class="w640" width="640" align="center">
                                    <?php if(is_array($logo)): ?>
                                        <img class="mobile_only" border="0"
                                            src="<?php echo e(array_key_exists('path', $logo) ? $logo['path'] : ''); ?>"
                                            alt="<?php echo e(isset($senderName) ? $senderName : ''); ?>"
                                            width="<?php echo e(array_key_exists('width', $logo) ? $logo['width'] : ''); ?>"
                                            height="<?php echo e(array_key_exists('height', $logo) ? $logo['height'] : ''); ?>" />
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <tr class="mobile_only">
                                            ...
                                            <td class="w410" width="410">
                                                <?php if(isset($reminder)): ?>
                                                    <p id="permission-reminder" class="footer-content-left"
                                                        align="left"><?php echo $reminder; ?></p>
                                                <?php endif; ?>
                                            </td>
                                            <td valign="top">
                                                <table align="right">
                                                    ...
                                                    <tr>
                                                        <?php if(isset($twitter)): ?>
                                                            <td><a href="https://twitter.com/<?php echo e($twitter); ?>"><img
                                                                        src="<?php echo e(Request::getSchemeAndHttpHost()); ?>/vendor/beautymail/assets/images/ark/twitter.png"
                                                                        alt="Twitter" height="25" width="25"
                                                                        style="border:0" /></a></td>
                                                        <?php endif; ?>

                                                        <?php if(isset($facebook)): ?>
                                                            <td><a href="https://facebook.com/<?php echo e($facebook); ?>"><img
                                                                        src="<?php echo e(Request::getSchemeAndHttpHost()); ?>/vendor/beautymail/assets/images/ark/fb.png"
...
<?php /**PATH /var/www/html/_bases/base_fixcity_fila3/laravel/Modules/Notify/resources/views/layouts/ark.blade.php ENDPATH**/ ?>