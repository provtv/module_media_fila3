...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6">
                    <label for="password" class="block text-sm font-medium text-gray-700 leading-5">
                        <?php echo e(__('user::auth.Password')); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6">
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700 leading-5">
                        <?php echo e(__('user::auth.Confirm Password')); ?>
...
</div><?php /**PATH /var/www/html/_bases/base_fixcity_fila3/laravel/Themes/Sixteen/resources/views/livewire/auth/passwords/reset.blade.php ENDPATH**/ ?>