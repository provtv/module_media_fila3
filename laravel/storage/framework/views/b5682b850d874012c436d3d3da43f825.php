<html>
	<head>
		...
		<style type="text/css"><?php echo $_theme->cssInLine('notify::css/sunny.css'); ?></style>
		<?php if(isset($css)): ?>
		<style type="text/css">
			<?php echo e($css); ?>
...
<?php /**PATH /var/www/html/_bases/base_fixcity_fila3/laravel/Modules/Notify/resources/views/emails/templates/sunny.blade.php ENDPATH**/ ?>