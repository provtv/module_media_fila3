<?php if($writable && \Illuminate\Support\Facades\Gate::check('createComment', $model)): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['model' => 'text','placeholder' => __('comments::comments.write_comment')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['submit' => true]); ?>
                <?php echo e(__('comments::comments.create_comment')); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/_bases/base_fixcity_fila3/laravel/Modules/Comment/packages/spatie/laravel-comments-livewire/resources/views/livewire/partials/newComment.blade.php ENDPATH**/ ?>