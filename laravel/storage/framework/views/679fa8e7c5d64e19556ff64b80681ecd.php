...
$__html = app('livewire')->mount($__name, $__params, 'lw-4109336396-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
                        ...
                        >
                            <?php echo $__env->make('filament-peek::partials.icon-rotate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </button>
                    </div>
                <?php endif; ?>

                <div class="filament-peek-modal-actions">
                    <?php echo $__env->make('filament-peek::partials.modal-actions', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/_bases/base_fixcity_fila3/laravel/vendor/pboivin/filament-peek/resources/views/preview-modal.blade.php ENDPATH**/ ?>