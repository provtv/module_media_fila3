...
<?php $component->withAttributes(['entry' => $entry]); ?>
    ...
    <div
        <?php echo e($attributes->merge($getExtraAttributes(), escape: false)->class(['fi-in-image flex items-center gap-x-2.5'])); ?>>
        <?php if($limitedStateCount): ?>
            <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                ...
                <?php $__currentLoopData = $limitedState; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stateItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <video
                        <?php echo e($getExtraImgAttributeBag()->class(['max-w-none object-cover object-center', 'rounded-full' => $isCircular, $ringClasses])->style([
...
<?php endif; ?>
<?php /**PATH /var/www/html/_bases/base_fixcity_fila3/laravel/Modules/Media/resources/views/filament/infolists/video-entry.blade.php ENDPATH**/ ?>