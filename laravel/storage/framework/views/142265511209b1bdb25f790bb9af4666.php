...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['title', 'text', 'background']));
...
foreach (array_filter((['title', 'text', 'background']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="bg-gray-900">
    <div class="relative isolate overflow-hidden pt-14">
        <img src="/storage/<?php echo e($background); ?>" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div class="text-center flex flex-col gap-8">
                <h1 class="text-4xl font-bold tracking-tight text-white sm:text-4xl"><?php echo e($title); ?></h1>
                <div class="mt-10 flex items-center  justify-center gap-x-12">
                    <?php $__currentLoopData = $buttons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $btn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e($btn['link']); ?>" class="<?php echo e($btn['class']); ?>"><?php echo e($btn['label']); ?></a>
...
<?php /**PATH /var/www/html/_bases/base_fixcity_fila3/laravel/Modules/UI/resources/views/components/blocks/hero/simple_centered_with_background_image.blade.php ENDPATH**/ ?>