<html>
	<head>
		...
		<style type="text/css"><?php echo e($_theme->cssInLine('notify::css/ark.css')); ?></style>
		<?php if(isset($css)): ?>
		<style type="text/css">
			<?php echo e($css); ?>
...
<?php /**PATH /var/www/html/_bases/base_fixcity_fila3/laravel/Modules/Notify/resources/views/emails/templates/ark.blade.php ENDPATH**/ ?>