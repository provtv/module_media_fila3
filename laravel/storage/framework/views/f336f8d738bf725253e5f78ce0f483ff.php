...
<head>
    ...
    <title></title>
    <style type="text/css">
        <?php echo $_theme->cssInLine('notify::css/minty.css'); ?>
    ...
    <div class="block">
        ...
        <table width="100%" bgcolor="#f6f4f5" cellpadding="0" cellspacing="0" border="0" id="backgroundTable"
            ...
            <tbody>
                <tr>
                    <td>
                        <table width="580" bgcolor="<?php echo e(Config::get('beautymail.colors.highlight', '#004cad')); ?>"
...
<?php /**PATH /var/www/html/_bases/base_fixcity_fila3/laravel/Modules/Notify/resources/views/emails/templates/minty.blade.php ENDPATH**/ ?>